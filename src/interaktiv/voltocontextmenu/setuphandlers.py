...
def remove_contextmenu_behavior():
    contextmenu_behavior = IContextmenuBehavior.__identifier__
    ...
    for portal_type in portal_types:
        ...
        if contextmenu_behavior in fti.behaviors:
            behaviors = [behavior for behavior in fti.behaviors if behavior != contextmenu_behavior]
            # noinspection PyProtectedMember
            fti._updateProperty('behaviors', tuple(behaviors))
